@extends('master')
@section('content')
    <section class="curriculum-page page-bg page-section">
        @include('components.sidebar')
        <div class="page-content">
            <div class="header d-flex align-items-center justify-content-between">
                <div class="">
                    <p class="">Hi Admin,</p>
                    <h3 class="">Your Showcase</h3>
                </div>
                <div class="">
                    <button type="button" class="primary-button" data-bs-toggle="modal" data-bs-target="#addShowcaseModal">Add
                        Showcase</button>
                </div>
            </div>
            <div class="content-wrapper">
                <div class="item-filters">
                    <div class="search ">
                        ...
                        <input type="text" class="search-2" placeholder="Search">
                    </div>
                </div>
                <table id="items" class="w-100 bg-white ">
                    <tr class="bg-[#F6F6F6] text-sm">
                        <th class="col-one"></th>
                        <th class="col-five">Author</th>
                        <th class="col-one">Link</th>
                    ...
                    <tr class="table-item">
                        <td class="">
                            <div class="first-column">
                                <div class="item-thumbnail">
                                    <img src="assets/img/showcase.png" alt="" id=''>
                                </div>
                                <div class="">
                                    <p class="first-p">Management Task Apps</p>
                        ...
                        <td class="">
                            <div class="action-buttons">
                                <button type="button" class="edit-icon-button" data-bs-toggle="modal"
                                    data-bs-target="#editShowcaseModal">
                                ...
                                <button type="button" class="delete-icon-button" data-bs-toggle="modal"
