    ...
    <section class="curriculum-page page-bg page-section">
        ...
        <div class="page-content">
            <div class="header d-flex align-items-center justify-content-between">
                <div class="">
                    <p class="">Hi Admin,</p>
                    <h3 class="">Your Gallery</h3>
                </div>
                <div class="">
                    <button type="button" class="primary-button" data-bs-toggle="modal" data-bs-target="#addPictureModal">Add
                        Picture</button>
                </div>
            </div>
                        ...
                        <td class="">
                            <div class="first-column">
                                <div class="item-thumbnail">
                                    <img src="assets/img/sample.jpg" alt="" id=''>
                                </div>
                                <div class="">
                                    <p class="first-p">IMS03976.JPG</p>
                                    <p class="second-p">7.5 MB</p>
                                </div>
                            </div>
                        </td>
                        <td class="">
                            <p class="">Hub road to campus</p>
                        </td>
                        <td class="">
        ...
        @include('components.add-picture-modal')
