...
@section('content')
    <section class="curriculum-page page-bg page-section">
                    ...
                    <tr class="table-item">
                        <td class="">
                            <div class="first-column">
                                <div class="curriculum-thumbnail">
                                    {{-- <img src="" alt="" id=''> --}}
                                    <p>PDF</p>
                                </div>
                                <div class="">
                                    <p class="first-p">Kurikulum_UIDesign</p>
                                    <p class="second-p">73.29 KB</p>
                                </div>
                            </div>
                        </td>
                        <td class="">Kurikulum UI/UX Design</td>
                        <td class="">UI/UX Design</td>
                        <td class="">
        ...
        @include('components.curriculum-modal')
