@extends('master')
@section('content')
    <section class="member-page page-section">
        ...
        <div class="page-content">
            ...
            <div class="content-wrapper">
                <div class="item-filters">
                    <div class="w-100 d-flex gap-2 gap-md-4 justify-content-between align-items-center">
                        ...
                        <div class="select-box">
                            <div class="select-box__current" tabindex="1">
                                <div class="select-box__value"><input class="select-box__input" type="radio"
                                        id="0" value="1" name="month" checked="checked" />
...
@section('script-body')
    ...
    <script>
        let editProfilePic = document.getElementById("edit-profile-pic");
        let editPic = document.getElementById("edit-pic");

        editPic.onchange = function() {
            editProfilePic.src = URL.createObjectURL(editPic.files[0]);
        }
    </script>
    <script>
        document.getElementById("delete-avatar-btn").addEventListener("click", function() {
            ...
            profilePicture.src = "assets/img/user.png";
            profilePicture.alt = "Default Profile Picture";
        });
    </script>
    <script>
        document.getElementById("delete-pic-btn").addEventListener("click", function() {
            var editProfilePicture = document.getElementById("edit-profile-pic");
            editProfilePicture.src = "assets/img/user.png";
            editProfilePicture.alt = "Default Profile Picture";
        });
    </script>
@endsection
