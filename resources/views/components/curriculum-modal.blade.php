<!-- add Modal -->
<div class="modal fade" id="addCurriculumModal" tabindex="-1" aria-labelledby="addCurriculumModal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header w-100">
                <h1 class="modal-title" id="exampleModalLabel">Add File</h1>
            ...
            <div class="modal-body w-100 pb-3">
                <form action="" class="add-form">
                    ...
                    <div class="w-100 pt-3">
                        <label for="">File Upload *format pdf/jpeg/png (Max 5 mb)</label>
                        <input type="file" name="" id="" class="">
                        {{-- Use class 'warning' in input tag for invalid input style --}}
                        <p class="input-warning">*File is too big</p>
                    </div>
                    <div class="w-100 pt-3">
                        ...
                        <div class="select-box">
                            ...
                            <ul class="select-box__list">
                                <li><label class="select-box__option" for="1" aria-hidden="aria-hidden">Frontend
                                        Development
                                </li>
                                <li><label class="select-box__option" for="2" aria-hidden="aria-hidden">Backend
                                        Development
                                </li>
...
<div class="modal fade" id="editCurriculumModal" tabindex="-1" aria-labelledby="editCurriculumModal"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header w-100">
                <h1 class="modal-title" id="exampleModalLabel">Edit File</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                    <i>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
